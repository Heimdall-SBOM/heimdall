...
TEST_F(BinaryFormatFactoryTest, CreateExtractorFromFormat)
{
   ...
   auto archiveExtractor = BinaryFormatFactory::createExtractor(BinaryFormatFactory::Format::Archive);
...
TEST_F(BinaryFormatFactoryTest, GetFormatExtensions)
{
   ...
   auto machoExtensions = BinaryFormatFactory::getFormatExtensions(BinaryFormatFactory::Format::MachO);
   EXPECT_FALSE(machoExtensions.empty());
   EXPECT_TRUE(std::find(machoExtensions.begin(), machoExtensions.end(), ".dylib") != machoExtensions.end());
}
...
TEST_F(BinaryFormatFactoryTest, IsExtensionForFormat)
{
   ...
   EXPECT_TRUE(BinaryFormatFactory::isExtensionForFormat(".dylib", BinaryFormatFactory::Format::MachO));
   EXPECT_TRUE(BinaryFormatFactory::isExtensionForFormat(".exe", BinaryFormatFactory::Format::PE));
   EXPECT_TRUE(BinaryFormatFactory::isExtensionForFormat(".a", BinaryFormatFactory::Format::Archive));
   EXPECT_TRUE(BinaryFormatFactory::isExtensionForFormat(".class", BinaryFormatFactory::Format::Java));
   EXPECT_TRUE(BinaryFormatFactory::isExtensionForFormat(".wasm", BinaryFormatFactory::Format::Wasm));

   EXPECT_FALSE(BinaryFormatFactory::isExtensionForFormat(".txt", BinaryFormatFactory::Format::ELF));
...
TEST_F(BinaryFormatFactoryTest, GetSupportedFormats)
{
   ...
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::ELF) != formats.end());
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::MachO) != formats.end());
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::PE) != formats.end());
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::Archive) != formats.end());
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::Java) != formats.end());
   EXPECT_TRUE(std::find(formats.begin(), formats.end(), BinaryFormatFactory::Format::Wasm) != formats.end());
}
