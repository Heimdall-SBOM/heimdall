#!/usr/bin/env python3
"""
Test script to generate and validate CycloneDX 1.5 output with the fixed implementation.
This creates mock output similar to what the fixed 1.5 generation would produce.
"""
...
def generate_mock_cyclonedx_1_5():
    """Generate a mock CycloneDX 1.5 SBOM with the structure from our fixes"""
...
def main():
    """Main test function"""
    print("🧪 Testing CycloneDX 1.5 JSON structure...")
    
    # Generate mock SBOM
    mock_sbom = generate_mock_cyclonedx_1_5()
    
    # Convert to JSON string
    json_output = json.dumps(mock_sbom, indent=2)
    
    # Save to file
    with open("mock_cyclonedx_1.5_output.json", "w") as f:
        f.write(json_output)
    
    print("📝 Generated mock CycloneDX 1.5 SBOM")
    print(f"📄 Saved to: mock_cyclonedx_1.5_output.json")
