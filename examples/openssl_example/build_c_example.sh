...
../../build/src/tools/sbom_loader ../../build/lib/heimdall-lld.so openssl_c_example_lld --format spdx-2.3 --output openssl_c_example.spdx.json
echo "[SUCCESS] Generated SPDX SBOM: openssl_c_example.spdx.json"

echo "[INFO] Generating SPDX 3.0 SBOM using LLD plugin..."
../../build/src/tools/sbom_loader ../../build/lib/heimdall-lld.so openssl_c_example_lld --format spdx-3.0 --output openssl_c_example.spdx3.json
...
../../build/src/tools/sbom_loader ../../build/lib/heimdall-lld.so openssl_c_example_lld --format cyclonedx-1.6 --output openssl_c_example.cyclonedx.json
...
../../build/src/tools/sbom_loader ../../build/lib/heimdall-gold.so openssl_c_example_gold --format spdx-2.3 --output openssl_c_example_gold.json
