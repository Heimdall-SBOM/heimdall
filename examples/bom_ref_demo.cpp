...
int main()
{
   ...
   SBOMComponent libA{"libA",
                      "libA-1.0.0",
                      "libA",
                      "1.0.0",
                      "library",
                      "pkg:generic/libA@1.0.0",
                      "MIT",
                      "Core library providing basic functionality",
                      "required",
                      "com.example",
                      "application/x-sharedlib",
                      "Copyright 2025 Example Corp",
                      "cpe:2.3:a:example:liba:1.0.0:*:*:*:*:*:*:*:*",
                      "Example Corp",
                      "Example Corp",
                      "Example Corp",
                      {},
   ...
   SBOMComponent libB{"libB",
                      "libB-2.0.0",
                      "libB",
                      "2.0.0",
                      "library",
                      "pkg:generic/libB@2.0.0",
                      "Apache-2.0",
                      "Advanced library with enhanced features",
                      "required",
                      "com.example",
                      "application/x-sharedlib",
                      "Copyright 2025 Example Corp",
                      "cpe:2.3:a:example:libb:2.0.0:*:*:*:*:*:*:*:*",
                      "Example Corp",
                      "Example Corp",
                      "Example Corp",
                      {},
   ...
   SBOMComponent app{"app",
                     "app-1.0.0",
                     "myapp",
                     "1.0.0",
                     "application",
                     "pkg:generic/myapp@1.0.0",
                     "GPL-3.0",
   ...
   std::cout << "  - Example: heimdall-sbom plugin.so binary --format cyclonedx --output sbom.json "
                "--sign-key private.key --sign-algorithm RS256\n\n";
